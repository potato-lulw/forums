            ...
            <div className="flex justify-between gap-2 flex-col md:flex-row ">
                ...
                <div className="flex flex-col gap-2 mt-2 md:w-[30%] w-full ">
                    ...
                    <div className="rounded-md bg-myBg2 p-2 ">
                        <h2 className="text-myBlue font-medium text-base mb-2">Staff Online</h2>
                    ...
                    {/* Members Online */}
                    <div className="rounded-md bg-myBg2 p-2 ">
                        <h2 className="text-myBlue font-medium text-base mb-2">Members Online</h2>
                    ...
                    {/* Trending Content */}
                    <div className="rounded-md bg-myBg2 p-2 ">
                        <h2 className="text-myBlue font-medium text-base mb-2">Trending Content</h2>
